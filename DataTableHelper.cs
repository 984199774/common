...
namespace ProtocolAnalysis.Utilities
{
    /// <summary> 
    /// DataTable操作 
    /// </summary> 
    public abstract class DataTableHelper
    {
        ...
        /// DataTable转换为XML
        /// </summary>
        static public string ToXML(DataTable dt)
        {
        ...
        static public DataTable CreateDataTable(string tableName,string[] columns,List<object[]> lstValue)
        {
            ...
            foreach (object[] vals in lstValue)
            {
                dt.Rows.Add(vals);
            }          
            return dt.Copy();
